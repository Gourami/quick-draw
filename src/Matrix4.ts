...
export default class Matrix4 {
  ...
  /**
   * Multiply this matrix by `other` from the right (this = this * other).
   */
  ...
  /**
   * Alias for concat(). Returns this for chaining.
   */
  ...
  /**
   * Transform a 3D point (w = 1) by this matrix.
   */
  ...
  /**
   * Set this to the inverse of `other`. Leaves this unchanged if the determinant is 0.
   */
