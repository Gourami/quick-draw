...
function copy16(src: ArrayLike<number>): Float32Array {
...
/** Column-major 4×4 matrix, matching WebGL `uniformMatrix4fv`. */
export default class Matrix4 {
  elements: Float32Array;

  constructor(opt_src?: Matrix4 | { elements: ArrayLike<number> }) {
    if (opt_src && typeof opt_src === "object" && "elements" in opt_src) {
      this.elements = copy16(opt_src.elements);
    } else {
  ...
  set(src: Matrix4 | { elements: ArrayLike<number> }): this {
  ...
  /**
   * Multiply this matrix from the right: `this = this * other`.
   */
  ...
  /**
   * Transform a homogeneous vector by this matrix.
   */
  ...
  /**
   * Set this to the inverse of `other`. Unchanged if the determinant is 0.
   */
  ...
  /**
   * Rotation in degrees about axis `(x, y, z)` (need not be normalized).
   */
